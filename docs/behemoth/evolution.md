...
![mammoth-3D Toolhead](./behemoth.png)

In 2023, the open-source 3D printing landscape was largely defined by two platforms:

- Voron — known for precision engineering and strong community documentation  
- VZBot — known for aggressive speed and high-performance motion systems  
...
**Combine the structural precision of Voron with the speed-focused performance of VZBot — without compromise.**
...
It is the foundation of a standalone 3D printer platform — built with scalability, strength, and long-term evolution in mind.
...
## The mammoth Idler Pack — Refined Engineering
...
join the discussion in [**#behemoth-general**](https://discord.com/channels/1240273232247132233/1470169338995675187)
